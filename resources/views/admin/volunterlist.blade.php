    ...
    <div id="layout-wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                @else
                    <a href="{{route('add-volunter')}}" class="btn btn-success">Add Volunteer</a>
                @endif
            </div>
        </div>
        @if ($errors->any())
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="text-align: center;    font-size: 21px;">Shelter Volunteers List </h5>
                    </div>
                    <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <form action="{{route('volunter-list')}}" method="get" role="search"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="datatable"
                                    ...
                                    <thead>
                                    <tr role="row">
                                        <th class="sorting_asc col-sm-2" tabindex="0" aria-controls="datatable" rowspan="1"
                                            colspan="1" style="width: 158px;" aria-sort="ascending"
                                            aria-label="Name: activate to sort column descending">Sr.
                                        </th>
                                        <th class="sorting col-sm-2" tabindex="0" aria-controls="datatable" rowspan="1"
                                        ...
                                        <th class="sorting col-sm-2" tabindex="0" aria-controls="datatable" rowspan="1"
                                            ...
                                            aria-label="Start date: activate to sort column ascending">Email
                                        </th>
                                        <th class="sorting col-sm-2" tabindex="0" aria-controls="datatable" rowspan="1"
                                    ...
                                    @foreach($list as $l)
                                        <tr>
                                            ...
                                            <td class= "col-sm-2">{{$l->name}}</td>
                                            <td class= "col-sm-2">{{$l->f_name}}</td>
                                            <td class= "col-sm-2">{{$l->contact}}</td>
                                            <td class= "col-sm-2">{{$l->email}}</td>
                                            <td class= "col-sm-2">{{$l->city}}</td>
                                            @if(auth()->user()->name == "police")
                                            ...
                                            @else
                                                <td>
                                                    ...
                                                    <a class="btn btn-warning"
                                                       href="{{route('volunter-edit',['id'=>$l->id])}}">Edit</a>
                                                    <a class="btn btn-danger"
                                                       href="{{route('volunter-delete',['id'=>$l->id])}}">Delete</a>
                                                </td>
                                            @endif
                                        </tr>
                                    @endforeach()
